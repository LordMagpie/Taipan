...
public:
	...
	void RenderText(TTF_Font* Font, string Text, int x, int y, TextAlignment ta, SDL_Color Colour);
	void RenderTextInverse(TTF_Font* Font, string Text, int x, int y, SDL_Color Colour, SDL_Color BackColour);
