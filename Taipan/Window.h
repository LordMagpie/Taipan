...
public:
	...
	void RenderText(TTF_Font* Font, const char* Text, Vector2 pos, SDL_Color Colour);
	void RenderTextInverse(TTF_Font* Font, const char* Text, Vector2 pos, SDL_Color Colour, SDL_Color BackColour);
