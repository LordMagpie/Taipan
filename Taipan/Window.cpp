...
void Window::RenderText(TTF_Font* Font, const char* Text, int x, int y, SDL_Color Colour) {
...
void Window::RenderTextInverse(TTF_Font* Font, const char* Text, int x, int y, SDL_Color Colour, SDL_Color BackColour) {
